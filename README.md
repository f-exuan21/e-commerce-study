...
|메서드| URL                                              |
|---|--------------------------------------------------|
|GET| /v1/products?page=1&size=10&sort=price&order=asc |
#### 🔹쿼리 파라미터
|이름| 타입  | 설명                   | 필수 |
|---|-----|----------------------|-|
|page| int | 페이지 번호 (기본값 : 1)     ||
|size| int | 페이지당 상품 수 (기본값 : 10) ||
|sort| String | 정렬 기준(price, name)   | |
...
``` json
{
    ...
    "errorMessage": "지원하지 않는 정렬 필드 입니다."
}
```
